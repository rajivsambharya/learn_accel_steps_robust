...
from lah.algo_steps_box_qp import k_steps_eval_lah_accel_box_qp, k_steps_train_lah_accel_box_qp
...
class LAHBOXQPAccelmodel(L2Omodel):
    def __init__(self, **kwargs):
        super(LAHBOXQPAccelmodel, self).__init__(**kwargs)
