...
from lah_accel.algo_steps_logistic import k_steps_eval_lm_logisticgd, k_steps_train_lm_logisticgd
...
from lah_accel.lah_gd_model import sigmoid


class LMLOGISTICGDmodel(L2Omodel):
